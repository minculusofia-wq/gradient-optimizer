...
try:
    ...
    class MockMX:
        ...
        def triu(self, *args, **kwargs): return []
        def full(self, *args, **kwargs): return []
        def concatenate(self, *args, **kwargs): return []
...
def get_infinite_value_by_dtype(dtype):
...
def pad_prefix_caches(
    cache: List, input_lengths: List, dtype = "bfloat16"
) -> tuple:
    """
...
def pad_inputs(
    pad_value: int, inputs: List, dtype = "bfloat16"
) -> tuple:
    """
